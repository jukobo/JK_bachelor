...
dir_data_localisation = 'Data/Verse20_test_unpacked_spinetools/raw' #list of images, rember to remove files, that spinetools haven't used
#Outputs
Output_folder = 'Data/Verse20/Outlier_detection/crops_test_prep'
#Padding
Padding_output_directory = 'Data/Verse20/Outlier_detection/Padding_specifications'
Padding_output_filename = 'pad_test' # NOTE: Remember to change!
