...
dir_data_localisation = 'Data/Verse20_training_unpacked_spinetools/raw' #list of images, rember to remove files, that spinetools haven't used
#Outputs
...
Padding_output_filename = 'pad_training' # NOTE: Remember to change!
