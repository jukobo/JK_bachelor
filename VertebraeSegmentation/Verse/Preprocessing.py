...
with open("Other_scripts/list_of_subjects_validation_VERSE", "rb") as fp:   # Unpickling
...
### GPU CLUSTER ###
dir_data = 'Data/Verse20_validation_unpacked' #Overall folder. Defining specific below #'/scratch/s174197/data/Verse20/Verse20_test_unpacked' #'/Users/andreasaspe/Documents/Data/Verse20/Verse20_test_unpacked'
#ONLY FOR SAVING TIME AND GETTING THE RIGHT SUBJECTS
dir_data_localisation = 'Data/Verse20/VertebraeLocalisation2/Verse20_validation_prep/img'
#Outputs
Output_folder = 'Data/Verse20/VertebraeSegmentation/Verse20_validation_prep'
#Padding
Padding_output_directory = 'Data/Verse20/VertebraeSegmentation/Padding_specifications'
